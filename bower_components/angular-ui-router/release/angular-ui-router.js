...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   */
  this.$get = $get;
  $get.$inject = ['$rootScope', '$q', '$view', '$injector', '$resolve', '$stateParams', '$urlRouter', '$location', '$urlMatcherFactory', '$viewPreventUpdate'];
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory,   $viewPreventUpdateProvider ) {
    ...
    $state.transitionTo = function transitionTo(to, toParams, options) {
      ...
      if (options.notify) {
         ...
         * </pre>
         */
        if ($rootScope.$broadcast('$stateChangeStart', to.self, toParams, from.self, fromParams, to).defaultPrevented) {
          $urlRouter.update();
    ...
    function resolveState(state, params, paramsAreFiltered, inherited, dst, options) {
      ...
      forEach(state.views, function (view, name) {
        ...
        $rootScope.$broadcast('$viewResolving', name);
 ...
 * </pre>
 */
$ViewDirective.$inject = ['$state', '$injector', '$uiViewScroll', '$interpolate', '$viewPreventUpdate'];
function $ViewDirective(   $state,   $injector,   $uiViewScroll,   $interpolate, $viewPreventUpdateProvider) {
