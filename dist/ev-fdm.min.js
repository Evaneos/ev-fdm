...
!function(e){var t={menubar:!1,statusbar:!1,toolbar:"bold italic underline | alignleft aligncenter alignright | bullist",skin:!1,verify_html:!0,convert_fonts_to_spans:!0,inline:!0};angular.module("ev-tinymce",[]).directive("evTinymce",[function(){var n=0;return{template:'<div class="tiny-mce-wrapper"><div class="ev-placeholder-container"></div><div class="ev-tinymce-content"></div><div ng-click="focusTinymce()" class="ev-tinymce-toolbar"></div><div class="max-chars-info"></div></div>',restrict:"AE",replace:!0,require:"?ngModel",scope:{tinymceOptions:"="},link:function(i,a,o,c){var r="uiTinymce"+n++,l=a.find(".ev-tinymce-content");l.attr("id",r),a.find(".ev-tinymce-toolbar").attr("id",r+"toolbar");var s,d=function(){return s||(s=e.get(r)),s},m=angular.extend({fixed_toolbar_container:"#"+r+"toolbar"},t,i.tinymceOptions);m.maxChars=o.maxChars||m.maxChars||null;var u=85,v=function(e,t){var n=a.parent().find(".max-chars-info");n.text(e+" / "+t);var i=e/t*100>u,o=e>=t;n.toggleClass("max-chars-warning",i),n.toggleClass("max-chars-reached",o)},g=!1,f=!1,p="",h="",b=m.maxChars,x=function(){var e=d();e.setContent('<span class="placeholder-light">'+o.placeholder+"</span>")},y=function(e){var t=d();g?h===o.placeholder&&t.setContent(""):e!==o.placeholder&&x()},C=function(){var e=d(),t=l.html(),n=l.text(),i=b&&n.length>b,a=b&&h.length>b;if(f&&n===o.placeholder)p=t,h=n;else if(!i||!a&&h.length)a&&i?e.setContent(p):(c.$setViewValue(t),p=t,h=n);else{var r=n.substr(0,b);e.setContent(r,{format:"text"})}b&&v(h.length,b),f=""===n||n===o.placeholder,f&&o.placeholder&&y(n)};c.$render=function(){var e=d();e&&(c.$viewValue?e.setContent(c.$viewValue):o.placeholder&&(f=!0,x()))},i.focusTinymce=function(){var e=d();e&&e.focus()};var w=function(e){e.on("init",function(){c.$viewValue&&c.$render()}),e.on("ExecCommand",function(){C()}),e.on("KeyUp",function(){C()}),e.on("SetContent",function(e){e.initial||C()}),e.on("blur",function(){g=!1,l.blur(),C()}),e.on("focus",function(){g=!0,C()})};m.setup=w,m.elems=r,m.mode="exact",e.init(m),i.$on("$destroy",function(){var e=d();e&&e.destroy()}),e.execCommand("mceToggleEditor",!1,r)}}}])}(window.tinyMCE),tinymce.PluginManager.add("evimage",function(e){function t(){var t,n=e.dom,i=e.selection.getNode();t=i?{src:n.getAttrib(i,"src"),alt:n.getAttrib(i,"alt"),"class":n.getAttrib(i,"class"),dataPictureId:n.getAttrib(i,"data-picture-id")}:!1,e.settings.evimage(t,function(t){i?n.setAttribs(i,t):e.insertContent(n.create("img",t))})}e.addButton("evimage",{icon:"image",tooltip:"Insert/edit image",onclick:t,stateSelector:"img[data-picture-id]:not([data-mce-object],[data-mce-placeholder])"}),e.addMenuItem("evimage",{icon:"image",text:"Insert image",onclick:t,context:"insert",prependToContext:!0}),e.addCommand("mceImage",t)});

!function(){"use strict";angular.module("ev-upload",["ev-fdm"])}(),function(){"use strict";angular.module("ev-upload").directive("evPictureButtonUpload",["NotificationsService","$http",function(e){return{restrict:"AE",scope:{pictures:"=",buttonText:"@",tooltipText:"@",iconName:"@",url:"@",language:"=",maxFiles:"@",addPicture:"&",onPictureAdded:"&"},template:'<ev-upload settings="settings" file-success="addPicture({picture: file})"upload="newUpload(promise)"><div ng-hide="uploading"><button type="button" tabIndex="-1" class="btn btn-link ev-upload-clickable"tooltip="{{tooltipText}}"tooltip-placement="top"><span class="icon {{iconName}}"></span>{{buttonText}}</button></div><div class="ev-picture-uploading" ng-show="uploading"><div class="ev-picture-upload-label"> {{"Transfert en cours"| i18n}} </div><p> {{upload.done}} / {{upload.total}} </p></div><div ng-show="uploading" ev-promise-progress="uploadPromise"></div></ev-upload>',link:function(t,n,i){t.uploading=!1,t.settings={acceptedFiles:"image/*",url:t.url,maxFiles:t.maxFiles||100},t.pictures=t.pictures||[],t.$watch("url",function(e){t.settings.url=e}),t.newUpload=function(n){t.upload={done:0,total:"?"},t.uploading=!0,t.uploadPromise=n,n.then(function(){e.addSuccess({text:"Les images ont été transférées avec succès"})},function(){e.add({type:e.type.WARNING,text:"Certaines images n'ont pas pu être transférées."})},function(e){t.upload=e}).finally(function(){t.uploading=!1})},i.addPicture||(t.addPicture=function(e){e=e.picture;var n=e.data[0];t.language&&(Array.isArray(n.legend)&&(n.legend={}),n.legend[t.language]||(n.legend[t.language]={name:""})),t.pictures.unshift(n),t.onPictureAdded()})}}}])}(),function(){"use strict";angular.module("ev-upload").directive("evPictureUpload",["NotificationsService","$http",function(e,t){return{restrict:"AE",scope:{pictures:"=",addPicture:"=",url:"@",language:"="},template:'<ev-upload settings="settings" file-success="pictureUploaded(file)"class="ev-picture-upload" upload="newUpload(promise)"><div ng-hide="uploading"><div class="ev-picture-upload-label">{{ "Faites glisser vos images ici" | i18n }}</div><table style="width:100%"><tr><td style="width:114px"><button type="button" tabIndex="-1" class="btn btn-default ev-upload-clickable">{{ "Importer..." | i18n}}</button></td><td style="width:30px´; line-height: 36px;">{{ "ou" | i18n }}</td><td><form novalidate name="flickr" ng-class="{\'has-error\': flickr.$dirty && flickr.$invalid}"><input name="fUrl" placeholder="{{\'Lien Flickr\' | i18n}}" ng-model="$parent.flickrUrl" ng-pattern="flickrUrlPattern" required="" class="form-control" ng-change="uploadFlickrUrl(flickr)"/><div ng-show="flickr.fUrl.$dirty && flickr.fUrl.$invalid"><p class="control-label" for="fUrl" data-ng-show="flickr.fUrl.$error.pattern">{{ "L\'url doit être une photo flickr" | i18n}}</p></div></form></td></tr></table></div><div class="ev-picture-uploading" ng-show="uploading"><div class="ev-picture-upload-label"> {{"Upload en cours"| i18n}} </div><div class="spinner"></div><p> {{upload.done}} / {{upload.total}} {{ "photo(s) uploadée(s)" | i18n }} </p></div><div ng-show="uploading" ev-promise-progress="uploadPromise"></div></ev-upload>',link:function(e){e.flickrUrlPattern=/^(https\:\/\/)?www\.flickr\.com\/photos\/.*\/\d+.*$/,e.settings={acceptedFiles:"image/*",url:e.url}},controller:function(n){n.uploading=!1,n.pictures&&(console.log&&console.log('attribute pictures in ev-picture-upload is deprecated: use add-picture="pictures.unshift"'),n.addPicture=function(e){n.pictures.unshift(e)}),n.pictures=n.pictures||[],n.$watch("url",function(e){n.settings.url=e}),n.uploadFlickrUrl=function(e){if(e.$valid){var i=/(https\:\/\/)?www\.flickr\.com\/photos\/.*\/\d+/.exec(n.flickrUrl)[0],l=t.post(n.url,{"flickr-url":i});l.success(function(e){n.pictureSuccess({picture:e})}).success(function(){e.$setPristine(),n.flickrUrl=""}),n.newUpload(l),n.upload={done:0,total:1,progress:0}}},n.newUpload=function(t){n.upload=null,n.uploading=!0,n.uploadPromise=t,t.then(function(){e.addSuccess({text:"Les images ont été uploadées avec succès"})},function(){e.add({type:e.type.WARNING,text:"Certaines images n'ont pas pu être uploadées."})},function(e){n.upload=e}).finally(function(){n.uploading=!1})},n.pictureUploaded=function(e){var t=e.data[0];n.language&&(Array.isArray(t.legend)&&(t.legend={}),t.legend[n.language]||(t.legend[n.language]={name:""})),n.addPicture(t)}}}}])}(),function(e){"use strict";angular.module("ev-upload").directive("evUpload",["$log","$q","$timeout",function(t,n,i){var l={previewTemplate:!1,previewsContainer:!1,autoQueue:!0,maxFilesize:12,maxFiles:100,uploadMultiple:!1,parallelUploads:3};return{transclude:!0,restrict:"EA",replace:!0,scope:{settings:"=",uploadStart:"&upload",fileSuccess:"&",fileAdded:"&"},template:'<div class="ev-upload"><div ng-transclude> </div></div>',link:function(o,r){function a(e){return s.getAcceptedFiles().reduce(function(t,n){return t+n.upload[e]},0)}function d(){var e=r.find(".ev-upload-dropzone");return 0===e.length&&(e=r),e.addClass("dz-default"),e.addClass("dz-message"),e[0]}function u(){return r.find(".ev-upload-clickable")[0]}function c(t){p={done:0,progress:0};var l=function(){p.progress=100*a("bytesSent")/a("total"),p.total=s.getAcceptedFiles().length,o.deferred.notify(p)};s.off("uploadprogress",l).off("maxfilesexceeded");var o={deferred:n.defer(),hasFileErrored:!1};l(),s.once("error",function(){o.hasFileErrored=!0}),s.on("uploadprogress",l);var r=function(){return!s.files.filter(function(t){return t.status===e.QUEUED||t.status===e.ADDED||t.status===e.UPLOADING}).length},d=function(){t.$apply(function(){i(function(){r()&&(s.off("complete",d),i(function(){o.hasFileErrored?o.deferred.reject("filehaserrored"):o.deferred.resolve()}))})})};s.on("maxfilesexceeded",function(){o.deferred.reject("maxfilesexceeded")}),s.on("complete",d),t.currentUpload=o.deferred.promise,t.uploadStart({promise:o.deferred.promise}),t.currentUpload.finally(function(){s.removeAllFiles(!0),t.currentUpload=null})}o.fileSuccess=o.fileSuccess||function(){},o.fileAdded=o.fileAdded||function(){};var s=null,p=null,f={};o.$watch("settings",function(i){return i.url?(null!==s&&s.destroy(),i=angular.extend(l,i),s=new e(d(),angular.extend({clickable:u()},i)),o.currentUpload=null,s.on("addedfile",function(e){null===o.currentUpload&&o.$apply(c);var t=n.defer();f[e.name]=t;var i=function(){s.removeFile(e)};o.$apply(function(n){n.fileAdded({dropzoneFile:e,promise:t.promise,cancel:i})})}),s.on("uploadprogress",function(e,t){o.$apply(function(){f[e.name].notify(t)})}),s.on("success",function(e,t){o.$apply(function(n){f[e.name].resolve({file:t}),n.fileSuccess({file:t})})}),s.on("error",function(e,t,n){t||500!==n.status||(t=i.dictResponseError||"Unexpected error during the upload"),"Upload canceled."===t&&(t=i.dictCanceledUpload||"The upload has been canceled"),o.$apply(function(){f[e.name].reject(t)})}),s.on("canceled",function(e){var t=f[e.name];o.$apply(function(){t.reject(i.dictCanceledUpload||"The upload has been canceled")})}),void s.on("complete",function(){angular.isDefined(p)&&(p.done+=1)})):void t.warn("No url provided to the upload zone")},!0),o.$on("$destroy",function(){s.destroy()})}}}])}(Dropzone);
